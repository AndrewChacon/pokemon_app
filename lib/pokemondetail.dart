...
class PokeDetail extends StatelessWidget {
  ...
  bodyWidget(BuildContext context)=>Stack(
     ...
     children: <Widget>[
      //  if(pokemon.nextEvolution) next_evolution = true;
       Positioned (
           ...
           child: Column(
             ...
             children: <Widget>[
               ...
               Row(
                 ...
                 children: 
                 pokemon.type.map((t)=> 
                 FilterChip(backgroundColor: Colors.green,label: Text(t, style: TextStyle(color: Colors.white),), onSelected: (b){},)).toList(),
               ),
